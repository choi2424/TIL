                        ...
                        <table class="table table-bordered">
                           <tbody>
                              ...
                              <c:forEach items="${ list }" var="sboard">
                                 <tr>
                                    <td>${sboard.idx }</td>
                                    <td><a class="move" href="#" data-idx="${sboard.idx}">${ sboard.subject }</a></td>
                                    <td>${sboard.author }</td>
                                    <td><fmt:formatDate value="${ sboard.createdate }" pattern="yyyy/MM/dd" /></td>
                                    <td>${sboard.constraint }</td>
                                 </tr>
                              </c:forEach>
                     ...
                     <div class="box-footer clearfix">
                        <div class="row">
                              ...
                              <nav aria-label="Page navigation example">
                                 <ul class="pagination">
                                    ...
                                    <c:if test="${pageMaker.prev }">
                                       <li class="page-item">
                                          <a class="page-link" href="/sboard/list?pageNum=${pageMaker.startPage -1 }">Previous</a>
                                       </li>
                                    </c:if>
                                    <!-- 페이지 번호 출력 -->
                                 ...
                                 <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
                                    ...
                                    <c:if test="${pageMaker.next }">                                       
                                       <li class="page-item">
                                          <a class="page-link" href="/sboard/list?pageNum=${pageMaker.endPage +1 }">Next</a>
                                       </li>
                                    </c:if>
                           ...
                           <div class="col-6">
                              ...
                              <!--2)목록에서 제목 클릭할 때 사용  action="/sboard/get"-->
                        ...
                        <a class="btn btn-primary" href="/sboard/register" role="button">글쓰기</a>
   ...
   <script>
      ...
      Array.from(movePages).forEach(function(mv_page) {
         ...
         mv_page.addEventListener("click",function(event){
            ...
            actionForm.setAttribute("action","/sboard/list");

            
            actionForm.submit(); // sboard/list
