						...
						<div class="box-body">
							<div class="form-group">
								<label for="idx">IDX</label> <input type="text"
									class="form-control" id="idx" name="idx" value="${board.idx }"
									readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="createdate">CREATEDATE</label> <input type="text"
									...
									value="<fmt:formatDate value='${board.createdate}' pattern='yyyy/MM/dd' />"
									readonly>
							</div>
							<div class="form-group">
								<label for="editdate">EDITDATE</label> <input type="text"
									class="form-control" id="editdate" name="editdate"
									value="<fmt:formatDate value='${board.editdate}' pattern='yyyy/MM/dd' />"
									readonly>
							</div>
						</div>
