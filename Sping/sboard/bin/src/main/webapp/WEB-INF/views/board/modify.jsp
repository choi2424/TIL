						...
						<form role="form" method="post" action="./modify">						
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="createdate" name="createdate" value="<fmt:formatDate value='${board.createdate}' pattern='yyyy/MM/dd' />"  readonly>
								</div>
								<div class="form-group">
									<label for="editdate">editdate</label> 
									<input type="text" class="form-control" id="editdate" name="editdate" value="<fmt:formatDate value='${board.editdate}' pattern='yyyy/MM/dd' />"  readonly>
								</div>
							</div>

							<div class="box-footer">
								<button type="submit" class="btn btn-primary">수정완료</button>
								<button type="button" id="btn_get" class="btn btn-primary">취소</button>
							</div>
						</form>
					</div>
				</div>
